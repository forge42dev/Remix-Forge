...
export class ActionLens implements vscode.CodeLensProvider {
  provideCodeLenses(
    ...
    const functionPattern = /export\s+const\s+action\b/;
    ...
    for (let lineIndex = 0; lineIndex < document.lineCount; lineIndex++) {
      ...
      if (matches) {
        ...
        newCodeLens.command = {
          ...
          arguments: [document.uri, "action"],
          tooltip: `Generate authentication code for this action using the authentication from remix-auth`,
        };
